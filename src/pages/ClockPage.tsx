...
//34 个节点卡片的默认位置 (按本地保存的 Clock 布局对齐)
const DEFAULT_MODULE_POSITIONS: Record<string, { x: number; y: number; width: number; height: number }> = {
 ...
 "clk_a0pll子节点": { x: 1610, y: 1201, width: 200, height: 320 },
 "clk_cam0pll子节点": { x: 1603, y: 722, width: 200, height: 100 },
 "clk_cam1pll子节点": { x: 2350, y: 1610, width: 200, height: 350 },
 "clk_disppll子节点": { x: 1591, y: 911, width: 200, height: 230 },
 "clk_raw_axi子节点": { x: 2630, y: 1861, width: 200, height: 320 },
 "clk_sys_disp子节点": { x: 1848, y: 990, width: 200, height: 100 },
 ...
 "clk_apb_i2c子节点": { x: 1342, y: 51, width: 200, height: 300 },
 "clk_apb_vcsys子节点": { x: 1040, y: 950, width: 200, height: 170 },
 "clk_x2p子节点": { x: 1040, y: 1180, width: 200, height: 320 },
 "clk_vip_sys_2子节点": { x: 2626, y: 1608, width: 200, height: 170 },
 ...
 "clk_wgn子节点": { x: 2589, y: 1339, width: 200, height: 200 },
 "clk_eth_pll子节点": { x: 1057, y: 157, width: 200, height: 160 },
 "rtc_32k子节点": { x: 253, y: 5, width: 200, height: 160 },
};
