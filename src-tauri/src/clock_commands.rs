    ...
    for output_name in crate::clock_calc::OUTPUT_NAMES.iter() {
        let (source, divider, multiplier, frequency): (&str, i32, i32, f64) = match *output_name {
            ...
            _ => (
                ...
                1,
                1,
                compute_output_frequency(OSC_FREQUENCY_MHZ, 1, 1),
            ),
        };
...
fn get_parent_frequency(
    ...
    match parent_name {
        ...
        "clk_apb_i2c" => get_parent_frequency("clk_i2c", pll_configs, outputs),
        "clk_apb_vcsys" => get_parent_frequency("clk_fab_100M", pll_configs, outputs),
        "clk_x2p" => get_parent_frequency("clk_fab_100M", pll_configs, outputs),
        ...
        "clk_raw_axi" => get_parent_frequency("clk_cam1pll", pll_configs, outputs),
